    ...
    <div className="w-full max-w-3xl mx-auto reveal stagger-2">
      ...
      >
        <select
          ...
          className="px-4 py-4 bg-transparent font-mono text-[11px] uppercase tracking-wider text-stone-900 border-b md:border-b-0 md:border-r border-stone-900/10 focus:outline-none appearance-none cursor-pointer"
        >
